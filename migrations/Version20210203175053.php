 ...
 */
final class Version20210203175053 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project ADD CONSTRAINT FK_2FB3D0EE7FF61858 FOREIGN KEY (skills_id) REFERENCES skills (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
